...
case, this corresponds to the least-squares solution.

The acquired joint rates can then be commanded to the actuators. Different WW 
gaits (i.e. motion patterns~\cite{LucWalkingGaits}) are achieved by dynamically 
setting constraints in the Jacobian (i.e. by defining set joint rates according 
to the current phase of the WW motion).
