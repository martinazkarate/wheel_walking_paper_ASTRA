...
%================================================================
Following the Lunokhod mission, Russian engineers developed numerous planetary exploration rover concepts where they demostrated major increase in gradeability and obstacle negotiation performances by implementing a ``peristaltic" locomotion mode in some or a ``wheel-walking" mode in others ~\citep{Ehrenfreund1998}. The triple-bogie rover concept was conceived in the early phase of the ExoMars mission ~\citep{Patel2010} and has become the baseline for the rover's locomotion. Moreover this type of suspension has become widely accepted in the European space robotics community due to good locomotion performances and design simplicity. The location of the deployment actuators of the triple-bogie concept offers the WW mode for free and this is another great benefit of this suspension concept.
...
use of the transformation approach~\citep{Tarokh2005} which is in turn based 
on~\citep{MuirNeumann1987} to accurately model 6-DoF kinematics. It derives from 
the work in~\citep{Hidalgo-Carrio2014} to invert the Jacobian formula from the 
odometry kinematics.
...
motion patterns~\citep{LucWalkingGaits}) are achieved by dynamically setting 
...
~\citep{LucWalkingGaits}. Both modes are commanded at a 2 ~\unit{cm/s} body velocity.
